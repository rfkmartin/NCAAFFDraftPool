...
function print_body($link)
{
	...
	$SHOW_MONTHS=24;
	echo '<body>';
	echo '<table width="1080" border="10" align="left" cellpadding="0" cellspacing="0" id="main_table" class="main_table">';
	echo '  <tr>';
...
{
	echo '    <table width="100%" border="1" cellspacing="0" cellpadding="0" id="header">';
	echo '    <tr>';
	echo '    <td colspan="2">';
	echo '      <table width="100%" border="1" cellpadding="0" cellspacing="0">';
	echo '        <tr><td valign="bottom" class="table_header" width="70%"><img src="../images/Logo2017.png" alt="2017 NCAA Final Four Draft Pool">2017 NCAA Final Four Draft Pool</td>';
	echo '        <td valign="top">';
	//print_logon();
	echo '</td></tr>';
...
function print_top_n_teams($n,$link)
{
   ...
   while (list($team,$wins,$losses,$conference)=mysqli_fetch_row($data)) {
      echo '<tr><td>'.$team.'</td><td>'.$wins.'</td><td>'.$losses.'</td><td>'.$conference.'</td></tr>';
   }
   echo '</table>';
}
?>